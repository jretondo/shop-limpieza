...
const FooterListVentas = ({ listaCaja }) => {
  ...
  useEffect(() => {
    try {
      ...
      const totalCostos = listaCaja.totalesCosto;
      ...
      if (totalCostos.length > 0) {
        totalCostos.map((item) => {
          costos = costos + parseFloat(item.SUMA);
        });
      }
      if (totales.length > 0) {
        if (efectivo !== 0) {
          efectivoRow = (
            <TotalItemsVtas totalId={0} totalImporte={efectivo} colSize={4} />
          );
        }
        if (mercadoPago !== 0) {
          mercadoPagoRow = (
        ...
        if (debito !== 0) {
          debitoRow = (
            <TotalItemsVtas totalId={2} totalImporte={debito} colSize={4} />
          );
        }
        if (credito !== 0) {
          creditoRow = (
            <TotalItemsVtas totalId={3} totalImporte={credito} colSize={4} />
          );
        }
        if (ctacte !== 0) {
          ctacteRow = (
            <TotalItemsVtas totalId={4} totalImporte={ctacte} colSize={4} />
          );
        }
        if (Transferencias !== 0) {
          TransferenciasRow = (
        ...
        if (costos !== 0) {
          costosRow = (
            <TotalItemsVtas totalId={8} totalImporte={costos} colSize={4} />
          );
        }
        setTotalesPlant(
          <>
        ...
        setTotalesPlant(
          <TotalItemsVtas totalId={null} totalImporte={0} colSize={6} />,
        );
      }
    } catch (error) {
